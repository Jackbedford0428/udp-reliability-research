...
model_dscp = args.sr_model if args.sr_model is not None else ''
...
model = SrProfile(filepaths, model_prefix=route, model_id=model_id, model_dscp=model_dscp, dirc_mets=dirc_mets, epochs=epochs, test_mode=test_mode)
