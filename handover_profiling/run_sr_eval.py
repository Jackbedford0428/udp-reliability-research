...
#         '-r': ['BR', 'A', 'B', 'R', 'G', 'O2'],
#         # '-m': ['subBR', 'subA', 'sunB', 'subR', 'subG', 'subO2'],
#     }
# ]

# Run_Test_List('python3 ./eval_sr_handover_profile.py \
#     -dt train -it 1 \
...
# python3 ./eval_sr_handover_profile.py -dt test -it 1 -p 20240630_latest_model -d 2024-05-14 2024-05-15 2024-06-18-2 2024-06-19-2 2024-06-20-2 2024-06-21-2 -mm dl_lost -m subA
